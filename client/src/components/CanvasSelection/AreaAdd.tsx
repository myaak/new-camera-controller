...
const AreaAdd: React.FC<AreaAddProps> = ({ onPress }) => {
  ...
  return (
    <div className="canvas-add__container">
      <div className="canvas-add__background"></div>
      <div className="canvas-add__item">
        <div className="canvas-add__item__title">Добавить зону</div>
        ...
        <div className="canvas-add__item__buttons">
          ...
          <button onClick={() => submitAdding(areaName)}>Добавить</button>
        </div>
      </div>
    </div>
  );
